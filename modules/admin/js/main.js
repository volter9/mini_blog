...
return i.each(this.nodes,function(e){t[e.getAttribute("data-name")]=e.innerHTML}),t},e.exports=o},{"../helpers/utils":11}],2:[function(t,e,n){var o=t("./editor"),i=t("../helpers/dom"),r={components:{}}
...
d.setupContainer(),e.exports=d},{"../helpers/utils":11}],4:[function(t,e,n){var o=t("./components"),i=t("./settings"),r=t("../helpers/utils"),s=function(t){i.assign(t),r.toArray(document.querySelectorAll("[data-component]")).forEach(o.createComponent)}
e.exports=s},{"../helpers/utils":11,"./components":2,"./settings":6}],5:[function(t,e,n){function o(t){this.editor=t,this.actions={},this.init()}var i=t("../helpers/utils")
...
o.innerHTML=n?e:t,o.setAttribute("data-role",t),o.className="button",o.addEventListener("click",function(){i.trigger(this.getAttribute("data-role"),i.editor.current)}),this.editor.container.appendChild(o),n=n||e,n.button=o,this.actions[t]=n},o.prototype.trigger=function(t,e){this.actions[t]&&this.actions[t](e)},e.exports=o},{"../helpers/utils":11}],6:[function(t,e,n){var o={settings:{},get:function(t){return this.settings[t]?this.settings[t]:null},set:function(t,e){this.settings[t]=e},assign:function(t){this.settings=t}}
...
document.execCommand("insertHTML",!1,e)}),t.addEventListener("keyup",function(t){13===t.keyCode&&document.execCommand("formatBlock",null,"p")}),t.isEditable=!0)},o.unmakeEditable=function(t){t.removeAttribute("contenteditable")},e.exports=o},{}],10:[function(t,e,n){var o=function(t){t.on=function(t,e){this._events=this._events||(this._events={}),this._events[t]||(this._events[t]=[]),this._events[t].push(e)},t.emit=function(t){if(this._events=this._events||(this._events={}),this._events&&this._events[t]){var e=mini_blog.toArray(arguments).slice(1)
this._events[t].forEach(function(t){t&&t.apply(t,e)})}}}
e.exports=o},{}],11:[function(t,e,n){var o=function(t,e){for(var n in t)t.hasOwnProperty(n)&&e(t[n],n)},i=function(t,e){var n={}
...
e.exports={toArray:a,extend:s,merge:r,diff:i,each:o}},{}],12:[function(t,e,n){(function(e){var n=t("./helpers/utils"),o={components:t("./core/components"),component:t("./core/component"),settings:t("./core/settings"),editor:t("./core/editor"),init:t("./core/init"),mod:t("./core/mod"),events:t("./helpers/events"),ajax:t("./helpers/ajax"),dom:t("./helpers/dom"),mvc:t("./mvc")}
n.extend(o,n),e.mini_blog=o}).call(this,"undefined"!=typeof global?global:"undefined"!=typeof self?self:"undefined"!=typeof window?window:{})},{"./core/component":1,"./core/components":2,"./core/editor":3,"./core/init":4,"./core/mod":5,"./core/settings":6,"./helpers/ajax":7,"./helpers/dom":9,"./helpers/events":10,"./helpers/utils":11,"./mvc":14}],13:[function(t,e,n){var o=function(t){return function(e){var n=function(){t.apply(this,mini_blog.toArray(arguments))}
return n.prototype=Object.create(t.prototype),mini_blog.each(e,function(t,e){n.prototype[e]=t}),n}}
e.exports=o},{}],14:[function(t,e,n){e.exports={mapper:t("./mapper"),model:t("./model"),view:t("./view")}},{"./mapper":15,"./model":16,"./view":17}],15:[function(t,e,n){var o=t("../helpers/events"),i=t("../helpers/utils"),r=t("../helpers/ajax"),s=t("./extend"),a=t("./model"),c={baseurl:"/",model:a},u=function(t){this.options=i.merge(c,t),this.models=[]}
o(u.prototype),u.prototype.parse=function(t){return t},u.prototype.fetch=function(t){var e=this
r.get([this.options.baseurl,"get",t]).success(function(t,n){var o=new e.options.model(e.parse(n))
e.models.push(o),e.emit("add",o)}).send()},u.prototype.create=function(t){var e=this
r.post([this.options.baseurl,"add"],t).success(function(n,o){t.id=o.id
var i=new e.options.model(t)
e.models.push(i),e.emit("add",i)}).send()},u.prototype.update=function(t){var e=this
...
r.post([this.options.baseurl,"remove",t]).success(function(){e.emit("destroy")}).send()},u.prototype.get=function(t){return this.models.filter(function(e){return e.id===t}).pop()},u.prototype.sync=function(){},u.extend=s(u),e.exports=u},{"../helpers/ajax":7,"../helpers/events":10,"../helpers/utils":11,"./extend":13,"./model":16}],16:[function(t,e,n){var o=t("../helpers/events"),i=t("../helpers/utils"),r=t("./extend"),s=function(t){var e=-1
t&&t.id&&(e=t.id,delete t.id),t=i.merge(this.data||{},t||{}),this.previous=t,this.data=t,this.id=e}
o(s.prototype),s.prototype.get=function(t){return this.data[t]?this.data[t]:!1},s.prototype.isNew=function(){return this.id>0},s.prototype.isDirty=function(){},s.prototype.set=function(t,e){t&&"undefined"!=typeof e?this.data[t]=e:this.data=i.merge(this.data,t),this.emit("change",this)},s.prototype.all=function(){return i.merge(this.data,{})},s.prototype.destroy=function(){this.data={},this.id=-1,this.emit("destroy")},s.prototype.reset=function(t){this.data=t,this.emit("change",this)},s.extend=r(s),e.exports=s},{"../helpers/events":10,"../helpers/utils":11,"./extend":13}],17:[function(t,e,n){var o=t("./extend"),i=function(t){this.node=t,this.initialize()}
i.prototype.initialize=function(){},i.prototype.render=function(){},i.extend=o(i),e.exports=i},{"./extend":13}]},{},[12])
